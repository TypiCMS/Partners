...
<item-list
    ...
    <template slot="table-row" slot-scope="{ model, checkedModels, loading }">
        <td class="checkbox" v-if="$can('update partners')||$can('delete partners')"><item-list-checkbox :model="model" :checked-models-prop="checkedModels" :loading="loading"></item-list-checkbox></td>
        <td v-if="$can('update partners')"><item-list-edit-button :url="'/admin/partners/'+model.id+'/edit'"></item-list-edit-button></td>
